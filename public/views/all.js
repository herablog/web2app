...
riot.tag('logo', '<h1>web2app</h1> <p>Easily Converter from Web URLs to App URIs</p>', 'logo , [riot-tag="logo"] { color: #fff; text-align: center; } logo h1 , [riot-tag="logo"] h1 { -webkit-animation: logo .24s ease-out .4s forwards; -moz-animation: logo .24s ease-out .4s forwards; -ms-animation: logo .24s ease-out .4s forwards; animation: logo .24s ease-out .4s forwards; font-family: \'Comfortaa\', cursive; font-size: 4.5rem; font-weight: 700; margin: 0; opacity: 0; position: relative; } logo p , [riot-tag="logo"] p { font-size: .9rem; }', function(opts) {
